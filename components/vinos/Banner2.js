        ...
        <>
            ...
            >
                <Col xs={4} sm={4} lg={3} className="p-0">
                    <img style={{width: '95%'}} className={`img_banner_vino_1 animate__animated animate__faster ${(entrada === true) ? 'animate__rollIn' : 'animate__rollOut animate__delay-0-5s'}`} src={`/images/vinos/Rocky/rocky_cabernet_sauvignon.png`} alt="Rocky - Cabernet Sauvingnon" />
                </Col>
                <Col xs={4} sm={4} lg={3} className="p-0">
